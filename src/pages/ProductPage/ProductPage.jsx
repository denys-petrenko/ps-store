...
const ProductPage = () => {
    ...
    return (
        <section className={styles.productPage}>
            ...
            <ProductDetails product={product} setShowFloatingCard={setShowFloatingCard} />
            <BestOffers />
            <ProductDescription product={product} isStickyMode={true} />
            <SubscriptionForm />
            <FloatingPurchaseCard product={product} showFloatingCard={showFloatingCard} isStickyMode={true} />
        </section >
    )
}
